...
pub fn style() -> Style {
    Style {
        ...
        visuals: Visuals {
            dark_mode: false,
            override_text_color: Some([0, 0, 0, 255]),
            widgets: Widgets {
        ...
        bg_fill: Color32::from_rgba_premultiplied(218, 218, 218, 255),
        weak_bg_fill: Color32::from_rgba_premultiplied(255, 0, 0, 255),
        bg_stroke: Stroke {
            width: 0.0,
        ...
        rounding: Rounding { nw: 3.0, ne: 3.0, sw: 3.0, se: 3.0 },
        fg_stroke: Stroke {
            width: 1.5,
            color: Color32::from_rgba_premultiplied(0, 0, 0, 255),
        },
        ...
        bg_fill: Color32::from_rgba_premultiplied(206, 206, 206, 255),
        weak_bg_fill: Color32::from_rgba_premultiplied(202, 202, 202, 255),
        bg_stroke: Stroke {
            width: 1.0,
            color: Color32::from_rgba_premultiplied(0, 0, 0, 255),
        },
        ...
        bg_stroke: Stroke {
            width: 1.0,
            color: Color32::from_rgba_premultiplied(218, 218, 218, 255),
        },
        rounding: Rounding { nw: 2.0, ne: 2.0, sw: 2.0, se: 2.0 },
        fg_stroke: Stroke {
            width: 1.0,
        ...
        expansion: 0.0,
            ...
            menu_rounding: Rounding { nw: 6.0, ne: 6.0, sw: 6.0, se: 6.0 },
